...
var view = function (count) {
    return Pux_Html_Elements.div([  ])([ Pux_Html_Elements.button([ Pux_Html_Events.onClick(Prelude["const"](Increment.value)) ])([ Pux_Html_Elements.text("Increment") ]), Pux_Html_Elements.span([  ])([ Pux_Html_Elements.text(Prelude.show(Prelude.showInt)(count)) ]), Pux_Html_Elements.button([ Pux_Html_Events.onClick(Prelude["const"](Decrement.value)) ])([ Pux_Html_Elements.text("Decrement") ]) ]);
};
...
var Bottom = (function () {
    function Bottom(value0) {
        this.value0 = value0;
    };
    Bottom.create = function (value0) {
        return new Bottom(value0);
    };
    return Bottom;
})();
var Reset = (function () {
...
var view = function (state) {
    return Pux_Html_Elements.div([  ])([ Prelude.map(Pux_Html_Elements.functorHtml)(Top.create)(Counter.view(state.topCount)), Prelude.map(Pux_Html_Elements.functorHtml)(Bottom.create)(Counter.view(state.bottomCount)), Pux_Html_Elements.button([ Pux_Html_Events.onClick(Prelude["const"](Reset.value)) ])([ Pux_Html_Elements.text("Reset") ]) ]);
};
var update = function (v) {
    return function (s) {
        if (v instanceof Top) {
            ...
            $3.topCount = Counter.update(v.value0)(s.topCount);
            return $3;
        };
        if (v instanceof Bottom) {
            ...
            $6.bottomCount = Counter.update(v.value0)(s.bottomCount);
            return $6;
        };
        if (v instanceof Reset) {
            var $9 = {};
            for (var $10 in s) {
                if (s.hasOwnProperty($10)) {
                    $9[$10] = s[$10];
                };
            };
            $9.topCount = Counter.reset(s.topCount);
            $9.bottomCount = Counter.reset(s.bottomCount);
            return $9;
        };
        throw new Error("Failed pattern match at CounterPair line 30, column 1 - line 33, column 1: " + [ v.constructor.name, s.constructor.name ]);
    };
};
var initialState = {
    topCount: Counter.initialState, 
...
},{"../Counter":194,"../Prelude":232,"../Pux.Html":238,"../Pux.Html.Elements":234,"../Pux.Html.Events":236}],196:[function(require,module,exports){
/* global exports */
"use strict";
...
var Pux = require("../Pux");
var CounterPair = require("../CounterPair");
var main = function __do() {
    var v = Pux.start({
        initialState: CounterPair.initialState, 
        update: Pux.fromSimple(CounterPair.update), 
...
},{"../Control.Monad.Eff":187,"../Control.Monad.Eff.Exception":183,"../CounterPair":195,"../Prelude":232,"../Pux":240,"../Signal.Channel":242}],231:[function(require,module,exports){
/* global exports */
"use strict";
